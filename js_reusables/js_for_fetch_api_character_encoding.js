...
if (parent.theLanguageUserIsLearningNow=="tr" || userInterfaceLanguage=="tr") { //ASLINDA: Yalnızca kullanıcı arayüz dili için gerekli. Birinci düzeyde öğrenilen dil için gerdekli değil ama ileride farklı tasarımlar farklı olasılıklar doğurabilir.
