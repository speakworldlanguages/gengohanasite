...
const filePathForTheWordOrPhrase = "../../../../speech_recognition_dictionary/"+parent.theLanguageUserIsLearningNow+"/1-7-2-key.txt";
...
const say1say2Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_7/lesson_2/key_1-2.mp3";
const say3say4Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_7/lesson_2/key_3-4.mp3";
const say5say6Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_7/lesson_2/key_5-6.mp3";
const say7say8Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNow+"/level_1/unit_7/lesson_2/key_7-8.mp3";
...
{
  setTimeout(function(){ keySoundAB.play(); }, 1000);
  setTimeout(function(){ sayAB.play(); }, 5000); // 1000 + 4000 = 5000
  setTimeout(goFromABtoCD,4500*parent.speedAdjustmentCoefficient+4000);
}

function goFromABtoCD()
{
  setTimeout(function(){ keySoundCD.play(); }, 2000); // after 1s fade out plus 1s fade in
...
{
  setTimeout(function(){ keySoundEF.play(); }, 2000);
  setTimeout(function(){ sayEF.play(); }, 5500); // 2000 + 3500 = 5500
  imgC.classList.add("toZeroOpacity");
  imgD.classList.add("toZeroOpacity");
...
function betweenCDandEF()
{
  ...
  setTimeout(goFromEFtoGH,6500*parent.speedAdjustmentCoefficient+3500);
}

function goFromEFtoGH()
{
  setTimeout(function(){ keySoundGH.play(); }, 2000);
