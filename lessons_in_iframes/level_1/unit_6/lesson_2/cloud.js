...
const filePathForTheWordOrPhrase = "../../../../speech_recognition_dictionary/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/1-6-2-cloud.txt";
...
const say1say2Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_6/lesson_2/cloud_1-2.mp3";
const say3say4Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_6/lesson_2/cloud_3-4.mp3";
const say5say6Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_6/lesson_2/cloud_5-6.mp3";
const say7say8Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_6/lesson_2/cloud_7-8.mp3";
...
const theSoundOfAir = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_6/lesson_2/nice_wind_seamless_loop.mp3"] , loop:true });
const cloudlySound = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_6/lesson_2/cloud.mp3"]  });
