...
const filePathForTheWordOrPhrase = "../../../../speech_recognition_dictionary/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/1-3-1-house.txt";
...
const say1say2Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_3/lesson_1/house_1-2.mp3";
const say3say4Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_3/lesson_1/house_3-4.mp3";
const say5say6Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_3/lesson_1/house_5-6.mp3";
const say7say8Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_3/lesson_1/house_7-8.mp3";
...
function loadingIsCompleteFunction()
{
  ...
  if (parent.theLanguageUserIsLearningNowToSetPathsAndNotes == "zh") { // Fangzi or Jia
    const pathOfNotificationRenHouse = "../../../../user_interface/text/"+userInterfaceLanguage+"/1-3-1_special_case_for_zh.txt";
    fetch(pathOfNotificationRenHouse,myHeaders).then(function(response){return response.text();}).then(function(contentOfTheTxtFile){
...
function betweenEFandGH()
{
  ...
  setTimeout(goFromGHtoIJ,8500*((parent.speedAdjustmentCoefficient+1)/2)); // See js_for_the_sliding_navigation_menu.js
}
