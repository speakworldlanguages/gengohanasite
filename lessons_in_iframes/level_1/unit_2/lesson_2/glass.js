...
const filePathForTheWordOrPhrase = "../../../../speech_recognition_dictionary/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/1-2-2-glass.txt";
...
const say1say2Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_2/lesson_2/glass_1-2.mp3";
const say3say4Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_2/lesson_2/glass_3-4.mp3";
const say5say6Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_2/lesson_2/glass_5-6.mp3";
const say7say8Path = "audio_files_for_listening/"+parent.theLanguageUserIsLearningNowToSetPathsAndNotes+"/level_1/unit_2/lesson_2/glass_7-8.mp3";
...
const realGlassSoundAB = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_2/lesson_2/realglass_1-2.mp3"]  });
const realGlassSoundCD = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_2/lesson_2/realglass_3-4.mp3"]  });
const realGlassSoundEF = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_2/lesson_2/realglass_5-6.mp3"]  });
const realGlassSoundGH = new parent.Howl({  src: ["lessons_in_iframes/level_1/unit_2/lesson_2/realglass_7-8.mp3"]  });
...
function unloadTheSoundsOfThisLesson() { // Call this as the last thing before leaving.
  ...
  successTone.unload();
  realGlassSoundGH.unload();
  realGlassSoundEF.unload();
  realGlassSoundCD.unload();
  realGlassSoundAB.unload();
  sayGH.unload();
  sayEF.unload();
  sayCD.unload();
  sayAB.unload();
